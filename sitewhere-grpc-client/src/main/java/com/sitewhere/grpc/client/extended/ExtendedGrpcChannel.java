 ...
 * @author Derek
 */
public class ExtendedGrpcChannel extends MultitenantGrpcChannel<DeviceStateBlockingStub, DeviceStateStub> {

    public ExtendedGrpcChannel(ITracerProvider tracerProvider, String host, int port) {
