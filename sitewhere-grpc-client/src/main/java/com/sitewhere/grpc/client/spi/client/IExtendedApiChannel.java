...
import com.sitewhere.spi.extended.event.IExtendedManagement;
 ...
 * @author Derek
 */
public interface IExtendedApiChannel<T extends MultitenantGrpcChannel<?, ?>>
	extends IExtendedManagement, IMultitenantApiChannel<T> {
}