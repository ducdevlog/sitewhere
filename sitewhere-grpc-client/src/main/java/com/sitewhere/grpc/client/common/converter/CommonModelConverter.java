...
public class CommonModelConverter {
	...
	if (grpc != null) {
	    ...
	    api.setIcon1D(grpc.hasIcon1D() ? grpc.getIcon1D().getValue() : null);
	    api.setIcon2DOn(grpc.hasIcon2DOn() ? grpc.getIcon2DOn().getValue() : null);
	    api.setIcon2DOff(grpc.hasIcon2DOff() ? grpc.getIcon2DOff().getValue() : null);
	    api.setIcon3DOn(grpc.hasIcon3DOn() ? grpc.getIcon3DOn().getValue() : null);
	    api.setIcon3DOff(grpc.hasIcon3DOff() ? grpc.getIcon3DOff().getValue() : null);
