package com.vin.iot.platform.infrared.aspect;
...
public class LoggerAspect {
    ...
    @Before("within(com.vin.iot.platform..*) && @annotation(com.vin.iot.platform.infrared.aspect.LogAround)")
    public void writeLogBefore(JoinPoint joinPoint) throws NoSuchMethodException {
        LOGGER.info("===== Start: {} ====", this.getMessage(joinPoint));
    }

    @AfterReturning("within(com.vin.iot.platform..*) && @annotation(com.vin.iot.platform.infrared.aspect.LogAround)")
    ...
    @AfterThrowing(value = "within(com.vin.iot.platform..*) && @annotation(com.vin.iot.platform.infrared.aspect.LogAround)", throwing="e")
